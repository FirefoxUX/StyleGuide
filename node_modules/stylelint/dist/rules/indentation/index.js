  ...
  return function (root, result) {
    ...
    function checkMultilineBit(source, newlineIndentLevel, node) {
      ...
      (0, _utils.styleSearch)({ source: source, target: "\n" }, function (match) {
        ...
        var postNewlineActual = /^(\s*)\S/.exec(source.slice(match.startIndex + 1))[1];
        ...
        if (postNewlineActual !== (0, _lodash.repeat)(indentChar, newlineIndentLevel)) {
          (0, _utils.report)({
